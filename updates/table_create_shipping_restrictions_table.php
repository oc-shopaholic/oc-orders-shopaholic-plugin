...
/**
 * Class TableCreateShippingRestrictionsTable
 * @package Lovata\OrdersShopaholic\Updates
 */
class TableCreateShippingRestrictionsTable extends Migration
{
    const TABLE_NAME = 'lovata_ordersshopaholic_shipping_restrictions';
