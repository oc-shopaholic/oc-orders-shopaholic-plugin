<?php return [
    ...
    'field'                => [
        ...
        'max_discount_description'   => 'If you specify a empty value, then the restriction of the discount will not be',
    ...
    'promo_mechanism_type' => [
        'without_condition_discount_order_position'             => 'Discount on the order position price without conditions',
        'without_condition_discount_order_position_description' => 'The discount on the price of the <strong>order position</strong> will be applied <strong>without checking any conditions</strong>. For example: Can be used when applying a coupon.',
        'without_condition_discount_shipping_price'             => 'Discount on the shipping price without conditions',
        ...
        'without_condition_discount_total_price'                => 'Discount on the order total price without conditions',
        'without_condition_discount_total_price_description'    => 'The discount on the <strong>total price</strong> of the order will be applied <strong>without checking any conditions</strong>. For example: Can be used when applying a coupon.',
    ],
];