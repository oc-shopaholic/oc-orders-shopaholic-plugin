<?php return [
    ...
    'field'                => [
        ...
        'order_discount_list'            => 'Список примененных скидок',
        'manager'                        => 'Менеджер',
    ...
    'promo_mechanism'      => [
        ...
        'quantity_limit_description' => 'Если указано значение = 1 и значение скидки = 100%, то скидка будет применена на одну единицу. Если указано значсение = 0, то скидка будет применена на все еденицы.',
    ],
    'permission'           => [
