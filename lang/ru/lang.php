<?php return [
    ...
    'promo_mechanism'      => [
        ...
        'calculate_per_unit'              => 'Рассчитывать скидку для 1 ед. товара (Только для скидки в процентах)',
        'calculate_per_unit_description'  => 'Если включено, то формула рассчета будет следующая: округление(цена_позиции * (1 - процент_скидки)) * количество. Иначе формула рассчета будет слеудющая: округление(цена_позиции * количество) * (1 - процент_скидки)',
    ],
    'permission'           => [
