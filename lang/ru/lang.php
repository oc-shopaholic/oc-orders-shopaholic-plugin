<?php return [
    ...
    'settings'             => [
        ...
        'creating_order_manager_group'             => 'Отправлять письма после создания заказа группе администраторов',
        'creating_order_manager_group_description' => 'Список email адресов менеджеров будет проигнорирован, если заполнен',
        'creating_order_manager_group_selected'    => 'Группа администраторов',
