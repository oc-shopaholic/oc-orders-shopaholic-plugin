 ...
 */
class ShippingTypeTest extends PluginTestCase
{
    ...
    /**
     * ShippingTypeTest constructor.
     */
    public function __construct()
    {
        $this->sModelClass = ShippingType::class;
        parent::__construct();
    }
